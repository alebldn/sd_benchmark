...
build it from scratch (documentation is available [here](https://docs.rs/gmp-mpfr-sys/latest/gmp_mpfr_sys/index.html#building-on-gnulinux)). The dependency, required to benchmark the CL signature scheme, can be disabled by removing "cl03"
from default features in **Cargo.toml**.
